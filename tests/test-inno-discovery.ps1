<#
    ...
    The functions are extracted from build/Build-FrivOSCInstaller.ps1 at run time rather than
...
$buildScript = Join-Path (Split-Path -Parent $here) 'build/Build-FrivOSCInstaller.ps1'
